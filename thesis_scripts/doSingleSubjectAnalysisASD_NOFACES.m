function doSingleSubjectAnalysisASD_NOFACES (subjASD)
    
    fprintf('evaluating single subject analysis for %s\n', subjASD);
    filename=[num2str(subjASD) '_NOFACES.set'];
    EEG = pop_loadset(filename); 
    subj1 = eeglab2fieldtrip(EEG, 'raw');
    
    %%
    
    elec2 = ft_read_sens([subjASD '_NOFACES.set']);
    ...
    %% eletrode layout plotting (57 eletrodes) and spectral analysis/peak picking
     run('/Users/arianalopes/Documents/MATLAB/DADOS FEITOS/estudos_grupo/nofaces/partes_ASD/sensor_layoutpower2D_ASD.m');
    
    %% localization of eletrodes in a standard head
     run('/Users/arianalopes/Documents/MATLAB/DADOS FEITOS/estudos_grupo/nofaces/partes_ASD/sensor_eletrodesstandardhead_ASD.m');
    
    %% connectivity studies between electrodes at sensor level
    run('/Users/arianalopes/Documents/MATLAB/DADOS FEITOS/estudos_grupo/nofaces/partes_ASD/sensor_connectivitystudies_ASD.m');
    ...
    %% source reconstruction and neural-activity-index (power/noise)
     run('/Users/arianalopes/Documents/MATLAB/DADOS FEITOS/estudos_grupo/nofaces/partes_ASD/source_reconstruction_ASD.m');
    
    %% identification of indices of trials with high and low alpha power and plot
     run('/Users/arianalopes/Documents/MATLAB/DADOS FEITOS/estudos_grupo/nofaces/partes_ASD/source_alpha_ASD.m');
    
    %% source reconstruction of low and high alpha activity epochs and plot
     run('/Users/arianalopes/Documents/MATLAB/DADOS FEITOS/estudos_grupo/nofaces/partes_ASD/source_differences_ASD.m');
    ...
    % the computation of the imaginary part of coherency
     ...
     run('/Users/arianalopes/Documents/MATLAB/DADOS FEITOS/estudos_grupo/nofaces/partes_ASD/source_connectivityanalysis_ASD.m');
