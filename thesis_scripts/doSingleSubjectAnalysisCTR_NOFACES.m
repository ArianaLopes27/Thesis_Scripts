function doSingleSubjectAnalysisCTR_NOFACES (subjCTR)
    
    fprintf('evaluating single subject analysis for %s\n', subjCTR);
    filename=[num2str(subjCTR) '_NOFACES.set'];
    EEG = pop_loadset(filename); 
    subj1 = eeglab2fieldtrip(EEG, 'raw');
    
    %%
    
    elec2 = ft_read_sens([subjCTR '_NOFACES.set']);
    ...
    %% eletrode layout plotting (57 eletrodes) and spectral analysis/peak picking
     run('/Users/arianalopes/Documents/MATLAB/DADOS FEITOS/estudos_grupo/nofaces/partes_CTR/sensor_layoutpower2D_CTR.m');
    
    %% localization of eletrodes in a standard head
     run('//Users/arianalopes/Documents/MATLAB/DADOS FEITOS/estudos_grupo/nofaces/partes_CTR/sensor_eletrodesstandardhead_CTR.m');
    
    %% connectivity studies between electrodes at sensor level
    run('/Users/arianalopes/Documents/MATLAB/DADOS FEITOS/estudos_grupo/nofaces/partes_CTR/sensor_connectivitystudies_CTR.m');
    ...
    %% source reconstruction and neural-activity-index (power/noise)
     run('/Users/arianalopes/Documents/MATLAB/DADOS FEITOS/estudos_grupo/nofaces/partes_CTR/source_reconstruction_CTR.m');
    
    %% identification of indices of trials with high and low alpha power and plot
     run('//Users/arianalopes/Documents/MATLAB/DADOS FEITOS/estudos_grupo/nofaces/partes_CTR/source_alpha_CTR.m');
    
    %% source reconstruction of low and high alpha activity epochs and plot
     run('/Users/arianalopes/Documents/MATLAB/DADOS FEITOS/estudos_grupo/nofaces/partes_CTR/source_differences_CTR.m');
    ...
    % the computation of the imaginary part of coherency
     ...
     run('/Users/arianalopes/Documents/MATLAB/DADOS FEITOS/estudos_grupo/nofaces/partes_CTR/source_connectivityanalysis_CTR.m');
