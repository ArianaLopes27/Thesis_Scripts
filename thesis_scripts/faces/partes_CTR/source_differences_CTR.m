...
% this part is used only to make sure the dataset results are giving wright
% outcomes
...
sourceint1     = ft_sourceparcellate([], sourceint, dkatlas);  %theta
cfg              = [];
cfg.method       = 'surface';
...
mkdir(outputdir)
save(fullfile(outputdir,'sourceint1'),'sourceint1');  