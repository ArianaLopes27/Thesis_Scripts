function doGroupAnalysis_nofaces(subjlist_CTR, subjlist_ASD)
    ...
    inputdir_CTR='/Users/arianalopes/Documents/MATLAB/DADOS FEITOS/estudos_grupo/nofaces/partes_CTR';
    inputdir_ASD='/Users/arianalopes/Documents/MATLAB/DADOS FEITOS/estudos_grupo/nofaces/partes_ASD';
    ...
    for i=1:numel(subjlist_CTR)
        ...
        inputpath_CTR=fullfile(inputdir_CTR,['results_nofaces_theta_' subj]); %add "_theta_" to run the theta frequencies
        % CTR data
    ...
    for i=1:numel(subjlist_ASD)
        ...
        inputpath_ASD=fullfile(inputdir_ASD,['results_nofaces_theta_' subj]); %add "_theta_" to run the theta frequencies 
        % ASD data
...
%% save the results to the disk
 outputdir='results_Group_nofaces'; %add "_theta_"
 mkdir(outputdir)
